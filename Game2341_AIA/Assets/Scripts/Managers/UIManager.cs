...
void Update ()
    {
		if (Time.time > updateTime)
		{
			...
			systemsText.text = "Kyle Systems: " + systems + "%";
			if (systems < 25 && systems > 10)
			{
				systemsText.color = Color.yellow;
			}
			if (systems < 11)
			{
				systemsText.color = Color.red;
			}
			...
			if (weapon)
			{
				weaponText.text = "Weapon: PBW2800";
				weaponText.color = Color.green;
			} else
			{
			...
			if (link)
			{
				linkText.text = "link: active";
				linkText.color = Color.green;
			} else
			{
				linkText.text = "link: inactive";
