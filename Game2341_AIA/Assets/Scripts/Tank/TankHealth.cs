...
{
    public float startingHealth = 12f;               // The amount of health each tank starts with.
	...
	private TankControler tankControl;
    ...
    private void Awake()
    {
		...
		tankControl = GetComponent<TankControler>();
    }
